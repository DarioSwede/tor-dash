...
// never innerHTML, except the pre-built terrain SVG string, which is
// generated by our own push script (not by arbitrary email/calendar
// content) and is safe to inject as markup.
...
(function () {
  ...
  function render(payload) {
    ...
    if (payload.svg) {
      ...
      holder.innerHTML = payload.svg; // trusted: generated server-side, not user content
