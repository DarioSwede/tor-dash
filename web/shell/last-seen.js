// Per-device "have I looked at this yet" bookkeeping. Backs a couple of
// small pieces of UX: landing on the Morning Brief right after sign-in
// only when there's actually something new there (rather than wherever
// the URL hash happened to be left from the last visit -- see shell.js
// and module-registry.js's preferredInitialId), and an unseen-activity
// dot on the Log nav button (see that module's getBadgeCount).
